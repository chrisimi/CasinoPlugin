...
public class CasinoGUI {
	...
	public CasinoGUI(Main main, Player player) {
		this.player = player;
		CasinoGUI.main = main;
	...
	public void updateInv() { //aktualisierungs Methode um Inventar zu ver§ndern
		addItemsToInv();
	}
	...
	private void addInformationBlocks() { //informationBlocks
