...
public class AdminHelpCommand extends Command
{
    ...
    public void execute(Event event)
    {
        ...
        player.sendMessage("§6/casino exportdata [from database] [to database] [(optional) -overwrite] §8- Exports the data from one database to another database. Use -overwrite to overwrite the data (CAUTION! data loss). Valid databases: file, mysql");
    }
}
