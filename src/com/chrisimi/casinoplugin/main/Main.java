	...
	private void checkVersion()
	{
		...
		switch(result.getStatus())
		{
			...
			case UP_TO_DATE:
				...
				break;
			case DEVELOPMENT:
				CasinoManager.LogWithColor(ChatColor.GREEN + "This is a development version of the plugin and can containing errors and bugs. Please report them to the plugin developer! Discord: Chrisi#5409 or e-mail: chrisi050403@gmail.com");
			case ERROR:
			default:
